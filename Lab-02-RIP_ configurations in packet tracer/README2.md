...
[![RIP-CONFIG Topology](Topology2.png)](Topology2.png)

##📥 Download Packet Tracer Topology

Click below to download the RIP-CONFIG lab topology:

👉 [Download RIP-CONFIG Packet Tracer Lab](https://github.com/USERNAME/REPO/raw/main/Lab2_RIP_Configuation.pkt)
...
Router(config)#banner motd / —- UNAUTHORIZED ACCESS IS NOT ALLOWED —- /
                ...
                ## 15.The command of checking

				  1. Verify RIP Routing Configuration
